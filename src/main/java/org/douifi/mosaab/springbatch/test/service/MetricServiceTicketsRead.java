...
@Service
@Setter
public class MetricServiceTicketsRead {
    ...
    public MetricServiceTicketsRead(MeterRegistry meterRegistry, CollectorRegistry collectorRegistry) {
        this.meterRegistry = meterRegistry;
        this.collectorRegistry = collectorRegistry;

        ticketCounter =  Gauge.build()
                .name("spring_batch_readen_items")
                .help("Number of readen items ")
    ...
    public void pushMetrics() throws MetricException {  
       ...
       try {
           pushGateway.pushAdd(collectorRegistry, "sumo_xms_srr_readen_tickets_all", groupingKey);
       }catch (IOException e){
