...
@Service
@Setter
public class MetricServiceTicketsRejetes {
    ...
    public MetricServiceTicketsRejetes(MeterRegistry meterRegistry, CollectorRegistry collectorRegistry) {
        this.meterRegistry = meterRegistry;
        this.collectorRegistry = collectorRegistry;

        ticketCounter =  Gauge.build()
                .name("spring_batch_rejected_items")
                .help("Number of rejected items ")
    ...
    public void pushMetrics() throws MetricException {  // TODO : à décommenter quand le pushgateway sera à nouveau opérationnel
       ...
       try {
           pushGateway.pushAdd(collectorRegistry, "sumo_xms_srr_rejected_tickets_all", groupingKey);
       }catch (IOException e){
